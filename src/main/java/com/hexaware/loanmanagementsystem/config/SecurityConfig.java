...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {      //normal spring security+JWT
    	return http.csrf().disable().cors().and()               
                ...
                .requestMatchers("/api/admin/authenticate","/api/v1/admin-details/addadmin","/api/v1/customer-details/addcustomer-detail","/api/v1/customer-account-details/addcustomeraccount-details","/api/login/adminlogin","/api/login/customerlogin","/api/v1/property-details/updateproperty/{id}","/api/login/userlogin" ,"/api/login/getrole/{name}","/api/login/getid/{name}","/v3/api-docs/**", "/swagger-ui/**","/swagger-resources/**").permitAll()
                .and()
